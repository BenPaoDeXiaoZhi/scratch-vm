 ...
 * @type {FetchFunction}
 */
let myFetch: any = globalThis.fetch;
 ...
 */
const setFetch = (newFetch: any): void => {
    myFetch = newFetch;
};
 ...
 */
const fetchWithTimeout = (resource: any, init: any, timeout: number): Promise<any> => {
    ...
    return Promise.race([
        myFetch(resource, Object.assign({signal}, init)).then((response: any) => {
...
export default { fetchWithTimeout, setFetch };
