class Color {
   ...
   */
  static decimalToRgb(decimal: number): any {
   ...
   */
  static rgbToDecimal(rgb: any): number {
   ...
   */
  static mixRgb(rgb0: any, rgb1: any, fraction1: number): any {
   ...
   */
  static darkenHex(hex: string, amount: number = 0.1): string {
