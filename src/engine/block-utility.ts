...
class BlockUtility {
  ...
  constructor(sequencer: any = null, thread: any = null) {
    /**
  ...
  getProcedureParamNamesIdsAndDefaults(
    ...
    return this.target.blocks.getProcedureParamNamesIdsAndDefaults(
      procedureCode,
      isGlobal,
    );
  }
  ...
  /**
     ...
     * @return {Array.<Thread>} List of threads started by this function.
     */
  startHatsWithParams(requestedHat: string, data: any, optTarget?: any): any {
    const fields =
   ...
   */
  ioQuery(device: string, func: string, args: any): any {
