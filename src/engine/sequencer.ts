...
class Sequencer {
  ...
  stepToBranch(thread, branchNum, isLoop) {
    ...
    const branchId = branchTarget.blocks.getBranch(currentBlockId, branchNum);
   ...
   */
  stepToProcedure(thread: any, procedureCode: string, globalTarget: any): void {
