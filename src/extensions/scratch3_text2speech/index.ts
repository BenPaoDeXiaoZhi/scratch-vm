...
// const XIGUA_SERVER_HOST =
//   typeof STUDY_WEB_HOST === "undefined"
//     ? process.env.STUDY_WEB_HOST
//     : STUDY_WEB_HOST;
...
class Scratch3Text2SpeechBlocks {
  ...
  getEditorLanguage(): string {
    const locale =
      formatMessage.setup().locale as string ||
      navigator.language ||
   ...
   */
  _getExtensionLocaleForSupportedLocale(locale: string): string | undefined {
   ...
   */
  _getSupportedLocales(): Array<any> {
