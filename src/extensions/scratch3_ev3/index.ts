...
class EV3Motor {
    ...
    /**
     * This motor's current position, in the range [-inf,inf].
     * @type {number}
     * @private
     */
    _position: number;
     ...
     */
    constructor (parent: EV3, index: number, type: string) {
        /**
         * The EV3 peripheral which owns this motor.
         * @type {EV3}
         * @private
...
class EV3 {
    ...
    /**
     * Flag to indicate if devices should be updated.
     * @type {boolean}
     * @private
     */
