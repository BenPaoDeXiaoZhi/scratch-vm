...
import * as ScratchXUtilities from "../extension-support/tw-scratchx-utilities";
...
const parseMonitorObject = (object, runtime, targets, extensions) => {
  ...
  if (object.cmd === "getVar:") {
    ...
    Object.prototype.hasOwnProperty.call(runtime.monitorBlockInfo, block.opcode)
  ) {
...
const sb2import = function (json, runtime, optForceSprite, zip) {
  ...
  return (
    Promise.resolve(assetsPromises)
...
export default { deserialize: sb2import };
