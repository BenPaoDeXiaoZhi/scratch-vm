 ...
 */
const serializeAssets = function (runtime: Runtime, assetType: string, optTargetId: string | undefined): Array<object> {
  const assetDescs: any[] = [];
  let targets;
  if (optTargetId) {
 ...
 */
const serializeSounds = function (runtime: Runtime, optTargetId?: string): Array<object> {
 ...
 */
const serializeCostumes = function (runtime: Runtime, optTargetId?: string): Array<object> {
