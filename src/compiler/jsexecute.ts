...
import blockUtility from './compat-block-utility';
...
let baseRuntime = '';
const runtimeFunctions: Record<string, string> = {};
 ...
 * @returns {string}
 */
const insertRuntime = (source: string): string => {
 ...
 */
const scopedEval = (source: string): any => {
