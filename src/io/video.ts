...
class Video {
   ...
   * @type {number}
   */
  _forceTransparentPreview: boolean;
  _renderPreviewFrame: any | null;
  ...
  getFrame({
    ...
    mirror = (this as any).mirror,
    format = Video.FORMAT_IMAGE_DATA,
    cacheTimeout = (this as any)._frameCacheTimeout,
  }: any): any {
    if (this.provider)
   ...
   */
  postData({ forceTransparentPreview }: any): void {
