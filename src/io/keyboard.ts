...
class Keyboard {
  ...
  _numeralKeyCodesToStringKey: Map<number, string>;
   ...
   */
  _keyStringToScratchKey(keyString: any): string {
   ...
   */
  _keyArgToScratchKey(keyArg: any): string {
