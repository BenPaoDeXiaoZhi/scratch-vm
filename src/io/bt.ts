...
class BT extends JSONRPC {
  ...
  _connected: boolean;
  _characteristicDidChangeCallback: any | null;
  _resetCallback: any | null;
  _discoverTimeoutID: any | null;
  _extensionId: string;
   ...
   */
  connectPeripheral(id: number, pin: string | null = null): void {
    const params: any = { peripheralId: id };
    if (pin) {
      params.pin = pin;
    }
