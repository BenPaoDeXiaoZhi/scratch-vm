...
class Scratch3LooksBlocks {
  ...
  /**
   * Timeout for bubble display
   * @type {number | null}
   */
  _bubbleTimeout: ReturnType<typeof setTimeout> | null = null;
  ...
  _onResetBubbles() {
    ...
    clearTimeout(this._bubbleTimeout as any);
  }
  ...
  _setCostume(target, requestedCostume, optZeroIndex) {
    ...
    if (typeof requestedCostume === "number") {
      ...
      typeof requestedCostume !== "undefined" &&
      requestedCostume !== null
    ) {
  ...
  switchCostume(args, util) {
    this._setCostume(util.target, args.COSTUME, false); // used by compiler
  }
  ...
  switchBackdrop(args) {
    this._setBackdrop(this.runtime.getTargetForStage(), args.BACKDROP, false);
  }
